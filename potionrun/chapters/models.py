...
class Chapter(models.Model):
    ...
    completed_sessions = models.PositiveIntegerField(_("Séances réalisées"), default=0)
    associated_routes = models.PositiveIntegerField(_("Parcours associés"), default=0)
